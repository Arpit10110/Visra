  ...
  return (
    <>
        <div className="flex justify-center items-center flex-col gap-[3.5rem] pb-[8rem]">
            ...
            <div className="hover:scale-[1.03] transition-all cursor-default flex flex-col w-[30%] border-primary-blue border-[2px] justify-center items-center p-[1.5rem] gap-[1.2rem] text-[1.3rem] rounded-[0.5rem]   below-sm:w-[85%]  ">
